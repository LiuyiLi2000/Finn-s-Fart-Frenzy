...
public class FartControl : MonoBehaviour
{
    ...
    public float autoFartTimer = 0f; 
    public float AutoFartTime = 45f; // Changed to a variable instead of a constant
    ...
    private void Update()
    {
        ...
        autoFartTimer += Time.deltaTime;
        if (autoFartTimer >= AutoFartTime)
        {
            TriggerFart();
            autoFartTimer = 0f;
        }
